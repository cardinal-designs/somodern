...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        serif: '"richmond-display", serif',
        sans: '"elza-text", sans-serif'
      },
      fontSize: {
        'h1': ['60px', { lineHeight: '1.2', letterSpacing: '0', }],
        'h2': ['40px', { lineHeight: '1.2', letterSpacing: '0', }],
        ...
        'sh2': ['11px', { lineHeight: '1.5', letterSpacing: '0.1em', fontWeight: '500' }],
        'sh3': ['16px', { lineHeight: '1', letterSpacing: '0', }],
        'sh4': ['12px', { lineHeight: '1.8', letterSpacing: '0.08em', fontWeight: '500' }],
        'sh5': ['13px', { lineHeight: '1.2', letterSpacing: '0.08em', fontWeight: '500' }],
        ...
        'nav': ['10px', { lineHeight: '1.68', letterSpacing: '0.06em', }],
        'cta': ['11px', { lineHeight: '1.2', letterSpacing: '0.1em', fontWeight: '500' }],
        'caption': ['14px', { lineHeight: '1', letterSpacing: '0', }],
        'tag': ['14px', { lineHeight: '1', letterSpacing: '0', fontWeight: '500' }],
        'link-sm': ['11px', { lineHeight: '1.2', letterSpacing: '0.04em', fontWeight: '500' }],
        ...
        'm-h4': ['25px', { lineHeight: '1.2', letterSpacing: '0', }],
        'm-sh1': ['11px', { lineHeight: '1.25', letterSpacing: '0.1em', }],
        'm-sh2': ['11px', { lineHeight: '1.5', letterSpacing: '0.1em', fontWeight: '500' }],
        'm-sh4': ['16px', { lineHeight: '1.25', letterSpacing: '0', }],
        'm-body-1': ['14px', { lineHeight: '1', letterSpacing: '0.02em', }],
        'm-body-2': ['12px', { lineHeight: '1.8', letterSpacing: '0.04em', }],
        'm-body-3': ['14px', { lineHeight: '1.4', letterSpacing: '0.02em', }],
